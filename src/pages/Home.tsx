        ...
        <div style={{ color: 'white', overflow: 'hidden' }}>
            ...
            <section style={{ padding: '100px 20px', maxWidth: '1200px', margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '80px' }}>
                    <div style={badgeStyle}>CHOOSE YOUR JOURNEY</div>
                ...
                <div style={featureGrid}>
                    <FeatureCard 
                        ...
                        title="농구 수업 찾기" 
                        desc="내 위치 기반으로 최적의 농구 레슨을 찾아보세요."
                    />
                    <FeatureCard 
                        to="/coaches" 
                        icon={<Users size={32} />} 
            ...
            <section style={trustSection}>
                <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', textAlign: 'center' }}>
                    ...
                    <div style={trustItem}>
                        <div style={trustIcon}><Award size={40} /></div>
                        <div style={trustValue}>Grade System</div>
                        <div style={trustLabel}>정교한 랭킹 시스템</div>
                    </div>
                </div>
            </section>
            ...
            <section style={ctaBanner}>
                <div style={{ textAlign: 'center' }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '2rem' }}>지금 바로 농구의 세계로</h2>
                    <Link to="/login" style={ctaBtn}>START NOW <ArrowRight size={20} style={{ marginLeft: 10 }} /></Link>
                </div>
            </section>
        </div>
    );
...
const trustSection: React.CSSProperties = { padding: '100px 20px', background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' };
...
const ctaBanner: React.CSSProperties = { padding: '150px 20px', background: 'linear-gradient(45deg, #000, #1a1a1a)', display: 'flex', alignItems: 'center', justifyContent: 'center' };
