        ...
        <div style={container}>
            ...
            <div style={grid}>
                ...
                <section style={card}>
                    ...
                    <ul style={list}>
                        <li>부정한 목적의 대량 구매 및 매칭 남용은 관련 법령에 의거하여 제한될 수 있습니다.</li>
                        <li>모든 매칭 기록과 대화 내역은 분쟁 발생 시 증빙 자료로 활용될 수 있습니다.</li>
                ...
                <section style={card}>
                    ...
                    <ul style={list}>
                        <li><strong>학생 자유 취소</strong>: 매칭 시작 24시간 전까지 취소 시 <strong>매칭 요청권이 100% 반환</strong>됩니다.</li>
                        <li><strong>노쇼 방지 정책</strong>: 시작 24시간 이내 취소 시, 요청권은 <strong>반환되지 않고 소멸</strong>됩니다. (직전 취소로 인한 코치의 기회비용 보호)</li>
                        <li><strong>코치 사유/상호 합의 취소</strong>: 기상 악화(우천 등)나 코트 사정으로 코치가 취소를 요청하고 <strong>학생이 승인하면 100% 반환</strong>됩니다.</li>
                        <li><strong>코치 노쇼</strong>: 예약된 시간에 코치가 나타나지 않아 신고가 접수/확인된 경우 <strong>즉시 100% 반환</strong>됩니다.</li>
                        <li>현금 결제 후 요청권 지급 전 취소는 고객센터를 통해 100% 환불 가능합니다.</li>
                    </ul>
                </section>
