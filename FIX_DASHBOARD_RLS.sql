...
-- 사용자가 '자신의 티켓만' 조회할 수 있도록 허용하는 정책 추가
CREATE POLICY "Users can view their own ticket balances" 
...
-- 사용자가 '자신의 포인트만' 조회할 수 있도록 허용하는 정책 추가
CREATE POLICY "Users can view their own point stats" 
