...
const translations = {
    ko: {
        ...
        sidebar: {
            ...
            mode_coach: "COACH",
            class_info: "COACH GRADE 가이드",
            terms: "정책 및 약관",
            coach_requests: "매칭 요청 관리",
            coach_history: "매칭기록 보관함",
            coach_schedule: "레슨 조율 관리",
            coach_grade: "COACH GRADE & PROMOTION",
            coach_curriculum: "커리큘럼 열람실",
            coach_financials: "매칭 수수료 및 정산",
            admin_users: "회원관리",
            admin_shop: "쇼핑몰 관리",
            admin_approvals: "가입승인",
            admin_regions: "지역관리"
        },
        dashboard: { home: "홈", booking: "매칭 요청", history: "매칭 내역", wallet: "지갑", security: "보안" },
        match: { create: "매치 만들기", filter_all: "전체", filter_pickup: "픽업 게임", filter_lesson: "코칭 매칭", filter_club: "클럽", join: "참여하기", wait: "대기 등록", full: "모집 완료" }
    },
    en: {
